-- =====================================================
-- Login Failed Attempts Tracking Functions
-- File này chứa các function để theo dõi và cảnh báo khi đăng nhập sai nhiều lần
-- Chạy file này trên Supabase SQL Editor sau khi đã chạy system-management.sql
-- =====================================================

-- Function: Đếm số lần đăng nhập sai gần đây
-- =====================================================
-- Đếm số lần đăng nhập thất bại trong khoảng thời gian nhất định (mặc định 15 phút)
-- Dependencies: get_user_by_email (từ system-management.sql)
...
-- Function: Log login attempt với tracking failed attempts
-- =====================================================
-- Cập nhật function log_login_attempt để trả về số lần đăng nhập sai
-- Dependencies: 
--   - get_user_by_email (từ system-management.sql)
--   - log_user_activity (từ system-management.sql)
--   - check_user_ban_status (từ system-management.sql)
--   - count_recent_failed_logins (function ở trên)
...
-- Hướng dẫn sử dụng:
-- =====================================================
-- 1. Đảm bảo đã chạy system-management.sql trước để có các dependencies:
--    - get_user_by_email()
--    - log_user_activity()
...
--
-- 3. Function log_login_attempt() sẽ trả về thêm field 'failed_attempts' 
--    trong kết quả JSON, cho phép frontend hiển thị cảnh báo khi:
--    - failed_attempts >= 2: Cảnh báo nhẹ
--    - failed_attempts >= 4: Cảnh báo mạnh
--    - failed_attempts >= 5: Tự động khóa (đã có trong trigger)
-- =====================================================
